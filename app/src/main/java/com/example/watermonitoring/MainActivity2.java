...
Toast.makeText(MainActivity2.this,esp,Toast.LENGTH_SHORT).show();
        ref.child("Week").child(esp).child("Distance").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot snapshot1 : snapshot.getChildren()) {
                    ...
                    pieChart.setCenterText("Water Distance");
                    pieChart.animate();
                }
            }
