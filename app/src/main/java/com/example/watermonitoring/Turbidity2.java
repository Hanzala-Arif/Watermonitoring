...
public class Turbidity2 extends AppCompatActivity {
    BarChart barChart;
    PieChart pieChart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_turbidity2);
        ...
        Toast.makeText(Turbidity2.this,esp, Toast.LENGTH_SHORT).show();
        ref.child("Week").child(esp).child("Turbidity").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
...
//
    ...
    private void sendNotification(String message, String token, String title) {
        try {
            RequestQueue requestQueue = Volley.newRequestQueue(Turbidity2.this);
...
//            userDetail.put("receiverImage", receiverImage);
    ...
    public void own(MenuItem item) {
        startActivity(new Intent(getApplicationContext(),Turbidity.class));
    }
