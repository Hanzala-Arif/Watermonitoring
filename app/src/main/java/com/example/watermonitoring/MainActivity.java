...
//        navigationView.setNavigationItemSelectedListener(MainActivity.this);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                meter2.setValue(distance);
                value = Integer.valueOf(distance);
                String tr=String.valueOf(tur);
                String Ph=String.valueOf(ph);
                String dt=String.valueOf(snapshot.child(espnum).child("Water_POINT").getValue(Integer.class));
...
//
  ...
  startActivity(new Intent(getApplicationContext(),Notification_Values.class));
    }
